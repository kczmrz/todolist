...
function ToDoList()
{
    const [activities, setActivities] = useState<string[]>([]);  /*Main array todolist */
    const [inputValue, setinputValue] = useState<string>("");    /*Var stores user input */
    ...
    /* This function catch something the user wrote */
